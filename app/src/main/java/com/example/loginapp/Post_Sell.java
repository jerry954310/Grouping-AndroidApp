...
public class Post_Sell extends AppCompatActivity {
    ...
    private Button AddPostButton,BackBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post__sell3);
        AddPostButton = (Button) findViewById(R.id.Add);
        //Return = (Button) findViewById(R.id.returnBtn);
    ...
    private void SendUserToMainactivity() {
        Intent mainIntent = new Intent(Post_Sell.this, MainActivity.class);
        ...
        FirebaseRecyclerAdapter adapter = new FirebaseRecyclerAdapter<Posts, PostsViewHolder>(options) {
            ...
            protected void onBindViewHolder(PostsViewHolder viewHolder, int position, Posts model) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent clickPostIntent = new Intent(Post_Sell.this, ClickPostActivity.class);
                ...
                viewHolder.CommentPostButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent commentsIntent = new Intent(Post_Sell.this, CommentsActivity.class);
    ...
    private void SendUserToPostsellactivity() {
        Intent mainIntent = new Intent(Post_Sell.this, Postsellactivity.class);
        mainIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(mainIntent);
        finish();
    }
