...
public class Postsellactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_postsellactivity);
        ...
        SelectPostImage = (ImageButton) findViewById(R.id.imageButton8);
        UpdatePostButton = (Button) findViewById(R.id.updateBtn);
    ...
    private void ValidatePostInfo() {
        ...
        if(ImageUri == null){
            Toast.makeText(Postsellactivity.this, "請選取圖片...", Toast.LENGTH_SHORT).show() ;
        }
        else if(TextUtils.isEmpty(Description)){
            Toast.makeText(Postsellactivity.this, "請寫點東西...", Toast.LENGTH_SHORT).show() ;
        }
        else{
                    ...
                    Postref.child(current_user_id + postRandomName).updateChildren(postsMap)
                            .addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                     if(task.isSuccessful()){
                                         SendUserToSellActivity();
                                         Toast.makeText(Postsellactivity.this, "新貼文上傳成功", Toast.LENGTH_SHORT).show();
                                         loadingBar.dismiss();
                                     }
                                     else{
                                         Toast.makeText(Postsellactivity.this, "錯誤...", Toast.LENGTH_SHORT).show() ;
                                         loadingBar.dismiss();
                                     }
                                }
                            });
    ...
    private void SendUserToSellActivity() {
        Intent mainIntent = new Intent(Postsellactivity.this, Post_Sell.class);
